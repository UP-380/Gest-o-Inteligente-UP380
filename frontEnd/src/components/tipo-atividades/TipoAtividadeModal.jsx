...
/**
 * Modal reutilizável para criar/editar tipo de atividade
 */
const TipoAtividadeModal = ({
  isOpen,
  onClose,
  onSubmit,
  formData,
    ...
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal-content" style={{ maxWidth: '600px', width: '90%' }} onClick={(e) => e.stopPropagation()}>
        <div className="modal-header">
          <h3 style={{ fontSize: '16px' }}>{editingId ? 'Editar Tipo de Atividade' : 'Novo Tipo de Atividade'}</h3>
          <button
            className="btn-icon"
            onClick={onClose}
            title="Fechar"
        ...
        <div className="modal-body">
          <form onSubmit={handleSubmit} className="tipo-atividade-form">
...
export default TipoAtividadeModal;
