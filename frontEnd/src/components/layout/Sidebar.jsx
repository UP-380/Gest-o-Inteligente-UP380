        ...
        <div className="sidebar-footer">
          <div className="sidebar-footer-content">
            ...
            {usuario && (
              ...
              >
                <Avatar
                  avatarId={usuario.foto_perfil}
                  nomeUsuario={usuario.nome_usuario || usuario.email_usuario || 'Usuário'}
                  size="small"
                  customImagePath={usuario.foto_perfil_path || null}
                />
                <div className="sidebar-footer-user-info">
                  <div className="sidebar-footer-user-name">
                    {usuario.nome_usuario || usuario.email_usuario || 'Usuário'}
                  </div>
                  <div className="sidebar-footer-user-email">
            ...
            <div className="sidebar-footer-meta">
              ...
              <div className="sidebar-footer-copyright">
                <span>© 2024 UP Gestão Inteligente</span>
              </div>
            </div>
          </div>
        </div>
