...
const GestaoColaboradores = () => {
  ...
  const [filtroStatus, setFiltroStatus] = useState('ativo'); // MODIFICADO: padrão para 'ativo' para que inativados sumam da lista
                      ...
                      },
                      {
                        ...
                        render: (colaborador) => (
                          <span style={{
                            ...
                            fontSize: '12px',
                            fontWeight: '500',
                            backgroundColor: colaborador.status === 'inativo' ? '#fee2e2' : '#dcfce7',
                            color: colaborador.status === 'inativo' ? '#ef4444' : '#10b981'
                          }}>
                            {colaborador.status === 'inativo' ? 'Inativo' : 'Ativo'}
                          </span>
                        )
                      }
                    ]}
