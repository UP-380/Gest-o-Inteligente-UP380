...
import './TarefaCardLista.css';

/**
 * Componente de Card de Tarefa para o modo Lista
 * Versão com badges de estimado e realizado na mesma linha
 * 
 * @param {Object} props
...
const TarefaCardLista = ({
  ...
  return (
    <div className="painel-usuario-tarefa-item-lista">
      <div className="painel-usuario-tarefa-item-lista-content">
        <div className="painel-usuario-tarefa-item-lista-main">
          <div className="painel-usuario-tarefa-item-lista-left">
        ...
        <div className="painel-usuario-tarefa-tags painel-usuario-tarefa-tags-lista">
...
export default TarefaCardLista;
