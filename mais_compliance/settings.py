"""
Django settings for mais_compliance project.
"""
...
MIDDLEWARE = [
    ...
    'accounts.middleware.AuditoriaMiddleware',  # Middleware de Auditoria
]

ROOT_URLCONF = 'mais_compliance.urls'
...
WSGI_APPLICATION = 'mais_compliance.wsgi.application'
...
DEFAULT_FROM_EMAIL = 'no-reply@maiscompliance.local'
